...
class KingExpressBusSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $busVipSingleId = DB::table('buses')->insertGetId([
            ...
            'floors' => 2, // Hoặc 2 nếu là cabin 2 tầng
            'seat_row_number' => 5, // 10 cabin mỗi bên
            'seat_column_number' => 2, // 1 cabin mỗi cột mỗi bên
        ...
        $busVipDoubleId = DB::table('buses')->insertGetId([
            ...
            'seat_column_number' => 2, // 1 cabin đôi mỗi cột mỗi bên
