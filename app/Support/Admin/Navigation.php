...
{
    /**
     * Return the ordered list of admin navigation items.
     * Each item: ['label', 'route', 'icon' (inline SVG path d= string), 'active_pattern'].
     *
    ...
    public static function items(): array
    {
        return [
            ...
            [
                ...
                'icon' => self::iconRoute(),
                'active' => request()->routeIs('admin.routes.*'),
            ],
            [
                'label' => 'Đội xe',
                'route' => 'admin.buses.index',
                'icon' => self::iconTruck(),
                'active' => request()->routeIs('admin.buses.*'),
            ],
            [
                'label' => 'Địa điểm',
                'route' => 'admin.locations.index',
                'icon' => self::iconLocation(),
                'active' => request()->routeIs('admin.locations.*'),
            ],
            [
                'label' => 'Phụ thu',
                'route' => 'admin.surcharges.index',
                'icon' => self::iconCurrency(),
                'active' => request()->routeIs('admin.surcharges.*'),
            ],
            [
    ...
    private static function iconTicket(): string
    {
        return '<path stroke-linecap="round" stroke-linejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-5.25h5.25M7.5 15h3M3.375 5.25c-.621 0-1.125.504-1.125 1.125v3.026a2.999 2.999 0 0 1 0 5.198v3.026c0 .621.504 1.125 1.125 1.125h17.25c.621 0 1.125-.504 1.125-1.125v-3.026a2.999 2.999 0 0 1 0-5.198V6.375c0-.621-.504-1.125-1.125-1.125H3.375Z" />';
    }

    private static function iconBus(): string
    {
        return '<path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" />';
    }

    private static function iconRoute(): string
    {
        return '<path stroke-linecap="round" stroke-linejoin="round" d="M9 6.75V15m6-6v8.25m.503 3.498 4.875-2.437c.381-.19.622-.58.622-1.006V4.82c0-.836-.88-1.38-1.628-1.006l-3.869 1.934c-.317.159-.69.159-1.006 0L9.503 3.252a1.125 1.125 0 0 0-1.006 0L3.622 5.689C3.24 5.88 3 6.27 3 6.695V19.18c0 .836.88 1.38 1.628 1.006l3.869-1.934c.317-.159.69-.159 1.006 0l4.994 2.497c.317.158.69.158 1.006 0Z" />';
    }

    private static function iconTruck(): string
    {
        return '<path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" />';
    }

    private static function iconLocation(): string
    {
    ...
    private static function iconCurrency(): string
    {
