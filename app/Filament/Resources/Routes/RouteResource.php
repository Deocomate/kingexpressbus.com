...
use App\Filament\Resources\Routes\RelationManagers\RouteStopsRelationManager;
...
class RouteResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Tuyến đường';
    ...
    {
        return [
            RouteStopsRelationManager::class,
        ];
    }
