...
class BookingPageController extends Controller
{
    public function index(Request $request, string $bus_route_slug)
    {
        ...
        try {
            ...
            // CHANGED: Fetch stops by route_id
    ...
    // The `booking` method does not need changes as it relies on the `pickup_point` value from the form,
    // which is correctly populated by the updated `index` method.
