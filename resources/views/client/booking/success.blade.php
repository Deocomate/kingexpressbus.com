...
<x-client.layout :web-profile="$web_profile ?? null" :main-menu="$mainMenu ?? []" :title="$title ?? __('client.booking.success.meta_title')" :description="$description ?? ''" body-class="bg-page">
    @php
    ...
    <section class="ksb-section-hero border-b border-amber-100 bg-amber-50 px-4">
        <div class="mx-auto max-w-7xl">
            <div class="mx-auto max-w-3xl text-center">
                <span
                    class="inline-flex items-center gap-2 rounded-sm border border-green-200 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-green-700">
                    <i class="fa-solid fa-circle-check" aria-hidden="true"></i>
                    {{ __('client.booking.success.title') }}
                </span>

                <div class="mx-auto mt-5 flex h-20 w-20 items-center justify-center rounded-sm bg-green-600 text-3xl text-white ">
                ...
                <div id="online-payment-success-message"
                    class="{{ $isPaid ? '' : 'hidden' }} mx-auto mt-5 max-w-2xl rounded-sm border border-green-200 bg-green-50 px-5 py-4 text-sm font-semibold leading-relaxed text-green-800">
                ...
                @if ($isAwaitingPaymentRequest)
                    <div id="online-payment-pending-message"
                        class="mx-auto mt-5 max-w-2xl rounded-sm border border-amber-200 bg-amber-50 px-5 py-4 text-sm font-semibold leading-relaxed text-amber-800">
            ...
            <div class="mx-auto mt-8 max-w-2xl rounded-sm border border-amber-200 bg-white p-6 ">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <span
                        ...
                        class="inline-flex items-center gap-2 rounded-sm px-4 py-2 text-xs font-semibold {{ $isPaid ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700' }}">
    ...
    <section class="ksb-section ksb-section-band px-4">
        <div class="mx-auto grid max-w-7xl grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-7">
            <article class="space-y-6 lg:col-span-2">
                <section class="rounded-sm border border-amber-100 bg-white p-5  sm:p-6">
                    <h2 class="mb-5 flex items-center gap-3 font-display text-lg font-bold text-gray-900">
                        <span
                            class="inline-flex h-9 w-9 items-center justify-center rounded-sm bg-primary-100 text-primary-700">
                            <i class="fa-solid fa-bus" aria-hidden="true"></i>
                        </span>
                        {{ __('client.booking.success.trip_info_title') }}
                    </h2>

                    <div class="mb-6 rounded-sm border border-amber-100 bg-amber-50/60 p-4 sm:p-5">
                        <div class="flex items-center gap-3 sm:gap-4">
                            ...
                            <div class="relative flex-1 border-t-2 border-dashed border-primary-300">
                                <span
                                    class="absolute -left-1.5 top-1/2 h-3 w-3 -translate-y-1/2 rounded-sm bg-primary-500"></span>
                                <span
                                    class="absolute -right-1.5 top-1/2 h-3 w-3 -translate-y-1/2 rounded-sm bg-primary-500"></span>
                            </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 text-sm sm:grid-cols-2 lg:grid-cols-4">
                        <div class="rounded-sm border border-gray-100 bg-gray-50 p-3.5">
                        ...
                        <div class="rounded-sm border border-gray-100 bg-gray-50 p-3.5">
                            ...
                            <p class="mt-2 font-semibold text-gray-900">{{ $booking->bus_name ?? __('client.booking.success.bus_name_fallback') }}</p>
                        </div>
                    </div>
                </section>
                ...
                <section class="rounded-sm border border-amber-100 bg-white p-5  sm:p-6">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div class="rounded-sm border border-green-100 bg-green-50/80 p-4">
                            <div class="mb-2 flex items-center gap-2">
                                <span
                                    class="inline-flex h-7 w-7 items-center justify-center rounded-sm bg-green-500 text-xs text-white">
                        ...
                        <div class="rounded-sm border border-rose-100 bg-rose-50/80 p-4">
                            <div class="mb-2 flex items-center gap-2">
                                <span
                                    class="inline-flex h-7 w-7 items-center justify-center rounded-sm bg-rose-500 text-xs text-white">
                ...
                <section class="rounded-sm border border-amber-100 bg-white p-5  sm:p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            <span
                                class="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-sm bg-primary-600 text-sm font-bold text-white">1</span>
                            <div>
                        ...
                        <div class="flex items-start gap-3">
                            <span
                                class="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-sm bg-primary-600 text-sm font-bold text-white">2</span>
                            <div>
                        ...
                        <div class="flex items-start gap-3">
                            <span
                                class="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-sm bg-primary-600 text-sm font-bold text-white">3</span>
                            <div>
            ...
            <aside class="space-y-5 lg:sticky lg:top-24 lg:self-start">
                <section class="rounded-sm border border-amber-100 bg-white p-5  sm:p-6">
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <span
                                data-payment-status-badge
                                class="inline-flex items-center gap-1 rounded-sm px-3 py-1 text-xs font-semibold {{ $isPaid ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700' }}">
                                <i class="fa-solid {{ $isPaid ? 'fa-check' : 'fa-clock' }}" aria-hidden="true"></i>
                                {{ $isPaid ? __('client.booking.success.paid') : __('client.booking.success.unpaid') }}
                            </span>
                        </div>
                    ...
                    @if ($isAwaitingPaymentRequest)
                        <div id="online-payment-note" class="mt-4 rounded-sm border border-primary-100 bg-primary-50 p-3 text-xs text-primary-700">
                ...
                <section
                    class="rounded-sm bg-slate-900 p-5 text-white  sm:p-6">
                    ...
                    <a href="tel:{{ preg_replace('/[^0-9+]/', '', $web_profile->hotline ?? '0865095066') }}"
                        class="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-sm bg-primary-600 px-4 py-3 font-semibold text-white transition-colors duration-200 hover:bg-primary-700">
