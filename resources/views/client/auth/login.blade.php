    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-page px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div class="relative z-10 w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div class="hidden lg:block space-y-8 pr-10 text-ink">
                <div>
                    <span class="inline-flex items-center px-3 py-1 rounded-sm text-xs font-semibold bg-accent-500 text-white uppercase tracking-wide">
                ...
                <div class="space-y-6 mt-10">
                    <div class="kx-panel flex items-start gap-4 p-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-muted mt-1">{{ __('client.auth.login.feature_manage_desc') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="kx-panel-strong p-8 md:p-10 w-full max-w-md mx-auto lg:ml-auto relative overflow-hidden">
                ...
                <form action="{{ route('client.login.submit') }}" method="POST" class="space-y-7">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2.5 cursor-pointer group/check">
                            <div class="relative flex items-center">
                                ...
                                <div class="w-5 h-5 border-2 border-neutral-300 rounded peer-checked:bg-brand-600 peer-checked:border-primary-600 transition-colors"></div>
                    ...
                    <div class="rounded-sm border border-neutral-200 bg-neutral-50 p-4">
                        <div class="flex items-start gap-3">
                            <div class="w-10 h-10 rounded-sm bg-white text-brand-600 flex items-center justify-center ">
                            ...
                            <div class="flex-1">
                                ...
                                <a href="{{ route('client.password.request') }}"
                                    class="mt-3 inline-flex items-center gap-2 text-sm font-semibold text-brand-600 hover:text-brand-700 transition-colors">
