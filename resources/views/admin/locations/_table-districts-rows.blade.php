{{--
  ...
  from _table-districts.blade.php for the normal full-page render.
--}}
<table class="min-w-full divide-y divide-gray-200">
    ...
    <tbody
        ...
        id="districts-sortable"
        data-sortable
        data-reorder-url="{{ route('admin.locations.districts.reorder') }}"
    >
        @forelse($paginator as $district)
        <tr class="hover:bg-gray-50 transition-colors" data-sortable-id="{{ $district->id }}">
            <td class="px-4 py-3">
                <input type="checkbox" name="ids[]" value="{{ $district->id }}" data-row-check class="rounded border-gray-300 text-brand-500 focus:ring-brand-500">
            </td>
