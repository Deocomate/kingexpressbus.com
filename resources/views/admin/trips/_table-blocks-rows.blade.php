{{--
  ...
  or bulk-bar — table.js swaps this into the [data-table] container's innerHTML,
  the container itself and the bulk-bar around it stay in the DOM).
  Rendered directly by TripController for X-Partial requests, and included
  from _table-blocks.blade.php for the normal full-page render.
--}}
